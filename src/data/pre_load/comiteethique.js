...
module.exports.send = async (interaction) => {
    ...
    return {
        embeds: [
            new EmbedBuilder()
                .setDescription("# Le <@&1307780177702551736> :\n> Le comité d’éthique est chargé de garantir **un environnement respectueux et inclusif** au sein d’Équinoxe.\n\nSi vous rencontrez un problème avec un adhérent ou une situation inconfortable, n’hésitez pas les contacter :\n### `comite-ethique@parti-equinoxe.fr`\nVous pouvez aussi allez leur posez des question sur Discord : <#1309909796883005590>.")
